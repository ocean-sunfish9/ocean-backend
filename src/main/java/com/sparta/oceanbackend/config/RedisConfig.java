...
public class RedisConfig {
  ...
  public CacheManager redisCacheManager(RedisConnectionFactory redisConnectionFactory) {
      ...
      GenericJackson2JsonRedisSerializer genericSerializer = new GenericJackson2JsonRedisSerializer(genericObjectMapper);

      RedisCacheConfiguration genericCacheConfig = RedisCacheConfiguration
              .defaultCacheConfig()
      ...
      RedisCacheConfiguration jacksonCacheConfig = RedisCacheConfiguration
              .defaultCacheConfig()
              .disableCachingNullValues() // null 값 제외
              .entryTtl(Duration.ofMinutes(cacheTtlMinutes)) // 만료 시간 설정
              .serializeKeysWith(RedisSerializationContext.SerializationPair
